...
// Массив картинок
    private int[] images = new int[] {R.drawable.dariax1, R.drawable.dariax2, R.drawable.dariax3, R.drawable.dariax4,
            R.drawable.dariax5, R.drawable.dariax6};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Получение кнопки и обработка события нажатия
